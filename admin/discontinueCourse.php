...
<html lang="en">
  <head>
    ...
    <title>Admin Panel | Discontinue Course</title>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    $enrollStudent=getDiscontinueStudents();
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody class="enrollStudentAllData">
                            <?php 
                                ...
                                {
                                    if($value['u_status']=='discontinueCourse')
                                    {
                                        $status='<span class="badge" style="background:#B4DF14">Discontinue Course</span>';
                                    }
